...
const THEMATIC_STYLES_BY_FORMAT: Record<string, ViralStyle[]> = {
  PHOTOREALISTIC_NEWS_FLASH: ['ARCHITECTURAL_OVERLAY', 'CANDLESTICK_HERO', 'MILITARY_AEROSPACE_METAPHOR', 'TICKER_TAPE_HERO', 'GLOWING_QUOTE', 'LINE_CHART'],
  PHOTOREALISTIC_LUXURY_LIFESTYLE: ['LUXURY_LIFESTYLE', 'MAGAZINE_COVER', 'CHESS_BOARD_STRATEGY', 'VAULT_SECURITY', 'GLOWING_QUOTE', 'TYPOGRAPHIC_MEGA_NUMBER', 'PREMIUM_CTA'],
...
const CTA_STYLE_POOL: ViralStyle[] = ['PREMIUM_CTA', 'LUXURY_LIFESTYLE', 'VAULT_SECURITY', 'GLOWING_QUOTE', 'MAGAZINE_COVER'];
