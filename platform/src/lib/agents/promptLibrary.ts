...
export const PROMPT_LIBRARY: Record<ViralStyle, string> = {
  ...
  // ── Human elements ───────────────────────────────────────────────────────
  POP_CULTURE_PORTRAIT: 'A cinematic, highly stylized portrait of [portraitDescription] standing confidently in a tailored dark suit. The background is a blurred cityscape or trading floor. Floating around the figure are 4 crisp white glowing circles containing corporate logos. Editorial-magazine treatment, not celebrity tabloid.',
  CARICATURE_PORTRAIT: 'A high-end 3D caricature portrait of [portraitDescription] with a slightly exaggerated head, holding a relevant prop (glowing microchip, gavel, ledger). Dark background. Studio lighting. New Yorker / Vanity Fair editorial caricature treatment.',
  EXPERT_CUTOUT: 'A professional, sharp photograph cutout of [portraitDescription] smiling confidently. Background is pure pitch black. Next to them is a floating list of massive text. Dramatic side-lit studio rim lighting.',
  ...
  LEADER_LOGO_CUTOUTS: 'A sharp, high-contrast cutout portrait of [portraitDescription] in a suit, standing centered and looking confidently forward. Floating symmetrically on their left and right sides are two crisp circular logo badges. Volumetric side-lighting, soft blurred natural background.',
  ...
  MAGAZINE_COVER: 'A layout in the style of a high-end financial magazine cover (Monocle or Bloomberg Businessweek). A striking central subject with massive elegant serif typography wrapping around it. Tight grid, generous whitespace, premium print color grading.',
