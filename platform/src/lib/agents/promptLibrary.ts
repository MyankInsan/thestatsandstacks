...
export const PROMPT_LIBRARY: Record<ViralStyle, string> = {
  ...
  HEATMAP_GRID: 'A detailed, high-contrast stock market heatmap grid resembling a tree map. The grid is composed of rectangular boxes in vibrant green representing positive returns and dark red representing negative returns, each box containing bold white ticker symbols (e.g., NVDA, MSFT, GOOGL) and percentage changes. Overlaid in the center is a circular cutout frame containing a colorful meme character (like a green Wojak) or a stylized portrait.',
  ...
  CHESS_BOARD_STRATEGY: 'A cinematic close-up of a marble chessboard. A lone pawn is knocking over a massive, ornate king piece. Dust particles in the air, dramatic rim lighting, dark background.',
  VAULT_SECURITY: 'A massive, impenetrable steel bank vault door bathed in harsh blue security lights. The door is slightly ajar, revealing glowing gold bars inside. High-end lighting, realistic textures.',
  SPORTS_RACING: 'A cinematic motion-blur shot of a sleek F1 racing car speeding past the camera on a dark track at night. Glowing neon sparks fly off the tires. High speed action.',
  SPACE_EXPLORATION: 'A hyper-realistic shot of a rocket launching into the dark night sky, massive flames and smoke illuminating the launchpad. High contrast, dramatic, detailed.',
  GAMING_LEVEL_UP: 'A nostalgic but premium 16-bit or glowing arcade style "LEVEL UP" notification hovering over a dark synthwave grid. Bright purple and cyan glow.',

  // Human Elements
  POP_CULTURE_PORTRAIT: 'A cinematic, highly stylized portrait of a famous movie star or pop culture figure (e.g., Leonardo DiCaprio in a pinstripe suit) standing confidently. The background is a blurred cityscape or trading floor. Floating around the figure are 4 crisp white glowing circles containing corporate logos.',
  CARICATURE_PORTRAIT: 'A high-end 3D caricature portrait of a famous tech CEO (e.g., Elon Musk or Jensen Huang) with a slightly exaggerated head, wearing a leather jacket, holding a glowing microchip. Dark background. Studio lighting.',
  EXPERT_CUTOUT: 'A professional, sharp photograph cutout of a famous investor (e.g., Cathie Wood) smiling confidently. Background is pure pitch black. Next to them is a floating list of massive text.',
  TRADER_DESK_SILHOUETTE: 'A moody, cinematic silhouette of a trader sitting at a multi-monitor desk in a dark room. The only light comes from the glowing screens reflecting off their glasses.',
  CROWD_PANIC: 'A blurred, chaotic scene of a massive crowd on a trading floor, hands in the air, papers flying. Desaturated colors with harsh red emergency lighting.',
  ...
  LEADER_LOGO_CUTOUTS: 'A sharp, high-contrast cutout portrait of a prominent political leader (e.g. Donald Trump) in a suit standing centered and looking confidently forward. Floating symmetrically on their left and right sides are two crisp circular logo badges: one containing a high-tech stealth jet and the other a corporate emblem. Volumetric side-lighting, soft blurred natural background.',
  CORPORATE_OFFICE_SPACE: 'A premium, clean editorial photograph of a modern tech corporate office interior. Concrete walls, glass partitions, desks with monitors, employees working in smart-casual attire. A concrete wall displays a clean, white corporate logo mark. Moody studio side-lighting.',
  MILITARY_AEROSPACE_METAPHOR: 'A cinematic, dramatic high-fidelity 3D render of a sleek hypersonic military cruise missile flying at extreme speeds through the upper atmosphere. A glowing orange jet flame and pink trail stream behind it. A dramatic sunset sky is in the background with soft clouds below. High-end rendering, detailed metallic textures.',

  // Typography & Layouts
  ARCHITECTURAL_OVERLAY: 'A cinematic, hyper-realistic, slightly desaturated photograph of a corporate headquarters or Wall Street building. High contrast, premium editorial photo.',
  MINIMALIST_CHECKLIST: 'A perfectly clean, Swiss-design minimalist checklist on a dark matte navy background. White text with neon green checkmarks. The layout is perfectly aligned and spaced.',
  GLOWING_QUOTE: 'A massive set of glowing neon quotation marks framing an elegant, bold serif font on a pitch black textured wall. Cinematic spotlighting hits the text.',
  NEON_TERMINAL: 'A retro-futuristic dark computer terminal screen. Glowing green monospaced text cursor blinking. Matrix hacker aesthetic.',
  MAGAZINE_COVER: 'A layout resembling a high-end financial magazine cover (like Forbes or TIME). A striking central subject with massive, elegant serif typography wrapping around it.',
  BILLBOARD_HIGHWAY: 'A photorealistic shot of a massive neon billboard over a dark, rainy highway at night. High contrast.',
  FLUID_LIQUID_TEXT: 'Abstract 3D typography made of dark, swirling metallic liquid and glowing lava. The liquid forms the words.',
